...
[[nodiscard]] std::string CRC64::get_checksum_str() const
{
    std::vector<char> bytes(sizeof(crc64_value));
    std::memcpy(bytes.data(), &crc64_value, sizeof(crc64_value));
    return bin2hex::bin2hex(bytes);
}
